...
public class FlintonVillager extends AbstractFriendlyHuman {
	...
	public FlintonVillager(Location location, boolean male) {
		super(ChatColor.GREEN + "Flinton Villager", 1, location, male ? MALE_TEXTURE_DATA : FEMALE_TEXTURE_DATA,
