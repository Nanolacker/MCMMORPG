...
public class EssentialCommands {
    public static void registerEssentialCommands() {
        ...
        CommandManager.register(openSkillTree);
        CommandManager.register(openQuestLog);
        CommandManager.register(openMap);
        CommandManager.register(killMe);
        CommandManager.register(partyCreate);
        CommandManager.register(partyDisband);
